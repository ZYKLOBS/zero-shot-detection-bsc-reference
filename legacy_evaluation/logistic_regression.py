...
X = df[["D2", "D1", "D0", "Δ(1,2)", "Δ(0,1)"]].values
y = df["label"].values
...
# Train/test split
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5, random_state=115, stratify=y)
...
plt.title("Precision-Recall Curve (Logistic Regression L2 Regularization)", fontsize=16)
...
feature_names = ["D2", "D1", "D0", "Δ(1,2)", "Δ(0,1)"]
